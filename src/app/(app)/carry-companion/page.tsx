...
export default function CarryCompanionListPage() {
      ...
      <main className="section-shell py-10">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
          <div className="glass w-full max-w-sm rounded-2xl p-6">
            <h2 className="text-xl font-semibold text-[color:var(--color-text)]">{t.carryCompanion.heading}</h2>
            <p className="mt-2 text-sm text-[color:var(--color-muted)]">{t.carryCompanion.text}</p>
          ...
          <div className="flex-1">
            ...
            {showResults ? (
              ...
              <p className="mt-6 text-sm text-[color:var(--color-muted)]">{t.carryCompanion.resultsHint}</p>
            )}
          </div>
        </div>
      </main>
